...
public class MainActivity extends Activity {
     ...
     * **/
    private final String TURING_APIKEY = "a3fc0f4298ba4d2da92b530d5c3f86cc";
    /**
     * 申请的secret（测试使用）
     * **/
    private final String TURING_SECRET = "e5de5230c0c3bce2";
    // 百度key（测试使用）
    private final String BD_APIKEY = "idrdnCAUMkTq9RUIIGTfve2f";
    // 百度secret（测试使用）
    private final String BD_SECRET = "wEQA5u681fEwnfbX0d0t3DGGRpUDBfGr";
